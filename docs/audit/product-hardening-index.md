...
| [#14 Public health and API responses leak absolute server paths](https://github.com/yang498-Peter/cloudstudio-platform/issues/14) | P2 | security/deploy | In audit | [#24](https://github.com/yang498-Peter/cloudstudio-platform/pull/24), [#25](https://github.com/yang498-Peter/cloudstudio-platform/pull/25) |
...
- `npm run test:public-api-sanitize`: passed.
