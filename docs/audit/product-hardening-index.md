...
| [#14 Public health and API responses leak absolute server paths](https://github.com/yang498-Peter/cloudstudio-platform/issues/14) | P2 | security/deploy | In audit / follow-up noted | [#24](https://github.com/yang498-Peter/cloudstudio-platform/pull/24) |
